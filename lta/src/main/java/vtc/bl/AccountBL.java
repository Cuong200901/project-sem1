...
public class AccountBL {
    ...
    // %-15s | %-10s | %-15s | %-15s |\n",
    // "ID", "User Name", "Password", "First name", "Last name", "Birth day", "Phone
    // number", "Email",
    ...
    // System.out.printf(
    // "| %-10s | %-15s | %-15s | %-10s | %-10s | %-10s | %-15s | %-15s | %-10s |
    // %-15s | %-15s |\n",
    // account.getaccountId(), account.getusername(), account.getuserpassword(),
    // account.getfirstname(),
    // account.getlastname(), account.getbirthday(), account.getphonenumber(),
    // account.getemail(),
    ...
    // if (a.length() < 6 || a.length() > 10 || a.trim().compareTo(a) != 0 ||
    // a.toLowerCase() != a
    // || a.matches("\\w+") == false) {
